    ...
    ...(detail === 'tiny'
      ...
      : {
          ...
          cloth: object.cloth?.enabled
            ? { pinMode: object.cloth.pinMode, wind: object.cloth.wind, resolution: object.cloth.resolution }
            : null,
          water: object.water?.enabled
            ? {
                style: object.water.style ?? 'custom',
