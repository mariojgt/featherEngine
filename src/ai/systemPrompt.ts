...
- Physics: Apply Force, Apply Impulse, Apply Torque, Set Physics, Set Velocity, Get Velocity, Fracture.
  ...
  - "Set Physics" enables/disables or reconfigures a Target object's runtime physics body during Play. Params: physicsEnabled, physicsBodyType dynamic|fixed|kinematic, physicsCollider box|sphere|capsule|mesh|convex, physicsIsTrigger, physicsMass, physicsGravityScale, physicsFriction, physicsLinearDamping, physicsAngularDamping. Target defaults to self and supports $player/$trigger/$cast or a wired Target reference. Use it for toggled solid doors/hazards, making pickups become triggers, changing a prop from fixed scenery to dynamic debris, or disabling a collider after collection. Prefer one-shot events/triggers over raw Update unless continuously changing values is intentional.
