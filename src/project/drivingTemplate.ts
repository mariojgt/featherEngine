...
async function buildCar(
  ...
  const vehicle: VehicleComponent = {
    ...
    crashDamageThreshold: 11,
    crashRolloverThreshold: 21,
    crashRolloverStrength: 0.36,
  ...
  const root: SceneObject = {
    ...
    physics: {
      ...
      mass: CAR_MASS, gravityScale: 1, friction: 1.05, linearDamping: 0.18, angularDamping: 0.65,
    },
    vehicle,
